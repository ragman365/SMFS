...
{
    /***********************************************************************************************/
    public partial class TestDeaths : DevExpress.XtraEditors.XtraForm
    {
        /***********************************************************************************************/
        public TestDeaths()
        {
        ...
        private void btnCompareFile_Click(object sender, EventArgs e)
        {
            ...
            DateTime as400DeceasedDate = DateTime.Now;
            ...
            for (int i = 0; i < lastrow; i++)
            {
                ...
                if ( doDeaths )
                {
                    if (dR.Length > 0)
                    {
                        ...
                        as400DeceasedDate = dx.Rows[i]["LAPDT8"].ObjToDateTime();
                        ...
                        if (str == "MISSED")
                        {
                            str = dx.Rows[i]["LAPDT8"].ObjToString();
                            if (str.Length == 8)
                            {
        ...
        private void gridMain_CustomColumnDisplayText(object sender, CustomColumnDisplayTextEventArgs e)
        {
            ...
            //string name = e.Column.FieldName.ObjToString();
            //if ( name.ToUpper() == "NUM")
            //{
            //    string num = e.GroupRowHandle.ObjToString();
            //    //e.DisplayText = num;
            //}
        }
        /***********************************************************************************************/
