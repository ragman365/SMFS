...
{
    /***********************************************************************************************/
    public partial class ImportCasketUsage : Form
    {
        private string importType = "";
        /***********************************************************************************************/
        public ImportCasketUsage( string type )
        {
            importType = type;
            InitializeComponent();
        }
        /***********************************************************************************************/
        private void ImportCasketUsage_Load(object sender, EventArgs e)
        {
            picLoader.Hide();
            labelMaximum.Hide();
            lblTotal.Hide();
...
//            this.Text = "Import Customer Data";
        ...
        private void printableComponentLink1_CreateMarginalHeaderArea(object sender, CreateAreaEventArgs e)
        {
            ...
            Printer.DrawQuad(5, 8, 5, 4, "Casket Usage Import Report", Color.Black, BorderSide.None, font, HorizontalAlignment.Left, VertAlignment.Bottom);
