...
{
    /****************************************************************************************/
    public partial class MSBankAchReport : DevExpress.XtraEditors.XtraForm
    {
        ...
        /****************************************************************************************/
        public MSBankAchReport(string report)
        {
            InitializeComponent();
            SetupTotalsSummary();
            workReport = report;
        ...
        /****************************************************************************************/
        private void MSBankAchReport_Load(object sender, EventArgs e)
        {
        ...
        private DataTable GetPayments()
        {
            ...
            cmd = "SELECT * FROM cust_payment_details WHERE `type` = 'INSURANCE UNITY' ";
        ...
        private void printableComponentLink1_CreateMarginalHeaderArea(object sender, CreateAreaEventArgs e)
        {
            ...
            Printer.DrawQuad(5, 7, 4, 3, title, Color.Black, BorderSide.None, font, HorizontalAlignment.Left, VertAlignment.Bottom);
