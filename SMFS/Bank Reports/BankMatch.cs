...
{
    /***********************************************************************************************/
    public partial class BankMatch : DevExpress.XtraEditors.XtraForm
    {
        /***********************************************************************************************/
        ...
        /***********************************************************************************************/
        public BankMatch( string title = "")
        {
            InitializeComponent();
            workTitle = title;
        }
        /***********************************************************************************************/
        private void BankMatch_Load(object sender, EventArgs e)
        {
...
//                    e.PS.InsertPageBreak(e.Y);
        ...
        private void btnSelectFile_Click(object sender, EventArgs e)
        {
            ...
            if ( dt == null)
            {
                MessageBox.Show("***ERROR*** Opening or Locating File");
                return;
            }
        }
        /***********************************************************************************************/
